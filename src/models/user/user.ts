...
const UserSchema = new Schema({
        ...
        password: {type: String, select: false, required: [true, "password is require"]},
        ...
        last_active_at: {type: Number, default: Date.now()},
        require_new_password: {type: Boolean, default: false},
        address: {type: String},
        id_document: {type: Schema.Types.ObjectId,  ref: 'UserDocument'},
        welcome_email_sent: {type: Boolean, default: false},
        activation_email_sent: {type: Boolean, default: false},
        address_verified: {type: Boolean, default: false},
        document_satisfied: {type: Boolean, default: false},

        day_created: {type: Number, required: true},
        week_created: {type: Number, required: true},
        month_created: {type: Number, required: true},
        year_created: {type: Number, required: true},
        week_day_created: {type: String, required: true},
        hour_created: {type: Number, required: true},
        am_or_pm: {type: String, required: true}
